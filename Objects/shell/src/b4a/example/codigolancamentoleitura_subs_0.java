...
try {
		Debug.PushSubsStack("Activity_Create (codigolancamentoleitura) ","codigolancamentoleitura",8,codigolancamentoleitura.mostCurrent.activityBA,codigolancamentoleitura.mostCurrent,32);
...
try {
		Debug.PushSubsStack("Activity_Pause (codigolancamentoleitura) ","codigolancamentoleitura",8,codigolancamentoleitura.mostCurrent.activityBA,codigolancamentoleitura.mostCurrent,69);
...
try {
		Debug.PushSubsStack("Activity_Resume (codigolancamentoleitura) ","codigolancamentoleitura",8,codigolancamentoleitura.mostCurrent.activityBA,codigolancamentoleitura.mostCurrent,65);
...
try {
		Debug.PushSubsStack("btCancelar_Click (codigolancamentoleitura) ","codigolancamentoleitura",8,codigolancamentoleitura.mostCurrent.activityBA,codigolancamentoleitura.mostCurrent,73);
...
try {
		Debug.PushSubsStack("btOk_Click (codigolancamentoleitura) ","codigolancamentoleitura",8,codigolancamentoleitura.mostCurrent.activityBA,codigolancamentoleitura.mostCurrent,77);
...
try {
		Debug.PushSubsStack("edPaginaAtual_TextChanged (codigolancamentoleitura) ","codigolancamentoleitura",8,codigolancamentoleitura.mostCurrent.activityBA,codigolancamentoleitura.mostCurrent,109);
