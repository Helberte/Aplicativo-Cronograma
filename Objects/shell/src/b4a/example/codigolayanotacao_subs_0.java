...
try {
		Debug.PushSubsStack("Activity_Create (codigolayanotacao) ","codigolayanotacao",6,codigolayanotacao.mostCurrent.activityBA,codigolayanotacao.mostCurrent,22);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (codigolayanotacao) ","codigolayanotacao",6,codigolayanotacao.mostCurrent.activityBA,codigolayanotacao.mostCurrent,93);
...
try {
		Debug.PushSubsStack("Activity_Pause (codigolayanotacao) ","codigolayanotacao",6,codigolayanotacao.mostCurrent.activityBA,codigolayanotacao.mostCurrent,41);
...
try {
		Debug.PushSubsStack("Activity_Resume (codigolayanotacao) ","codigolayanotacao",6,codigolayanotacao.mostCurrent.activityBA,codigolayanotacao.mostCurrent,30);
...
try {
		Debug.PushSubsStack("btCancelar_Click (codigolayanotacao) ","codigolayanotacao",6,codigolayanotacao.mostCurrent.activityBA,codigolayanotacao.mostCurrent,46);
...
try {
		Debug.PushSubsStack("btOk_Click (codigolayanotacao) ","codigolayanotacao",6,codigolayanotacao.mostCurrent.activityBA,codigolayanotacao.mostCurrent,52);
...
{ BA.debugLineNum = 57;BA.debugLine="Else if edAnotacao.Text.Trim = \"\" Then";
Debug.ShouldStop(16777216);
...
{ BA.debugLineNum = 79;BA.debugLine="else if Result.GetString(\"RESULTADO\") = 1 Then";
Debug.ShouldStop(16384);
...
try {
		Debug.PushSubsStack("edAnotacao_TextChanged (codigolayanotacao) ","codigolayanotacao",6,codigolayanotacao.mostCurrent.activityBA,codigolayanotacao.mostCurrent,110);
...
try {
		Debug.PushSubsStack("edTituloAnotacao_TextChanged (codigolayanotacao) ","codigolayanotacao",6,codigolayanotacao.mostCurrent.activityBA,codigolayanotacao.mostCurrent,104);
