...
try {
		Debug.PushSubsStack("Activity_Create (codigolayanotacao) ","codigolayanotacao",5,codigolayanotacao.mostCurrent.activityBA,codigolayanotacao.mostCurrent,24);
...
Debug.ShouldStop(8388608);
 BA.debugLineNum = 26;BA.debugLine="Activity.LoadLayout(\"Lay_Anotar\")";
...
codigolayanotacao.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Lay_Anotar")),codigolayanotacao.mostCurrent.activityBA);
 BA.debugLineNum = 27;BA.debugLine="banco.Initialize";
...
codigolayanotacao.mostCurrent._banco.runClassMethod (b4a.example.classbancodados.class, "_initialize" /*RemoteObject*/ ,codigolayanotacao.processBA);
 BA.debugLineNum = 29;BA.debugLine="edTituloAnotacao.RequestFocus";
...
try {
		Debug.PushSubsStack("Activity_KeyPress (codigolayanotacao) ","codigolayanotacao",5,codigolayanotacao.mostCurrent.activityBA,codigolayanotacao.mostCurrent,102);
...
if (RemoteObject.solveBoolean("=",_keycode,BA.numberCast(double.class, codigolayanotacao.mostCurrent.__c.getField(false,"KeyCodes").getField(true,"KEYCODE_BACK")))) { 
 BA.debugLineNum = 104;BA.debugLine="nomeDoLivro = \"\"";
Debug.ShouldStop(128);
codigolayanotacao._nomedolivro = BA.ObjectToString("");
 BA.debugLineNum = 105;BA.debugLine="qtPaginas = 0";
...
try {
		Debug.PushSubsStack("Activity_Pause (codigolayanotacao) ","codigolayanotacao",5,codigolayanotacao.mostCurrent.activityBA,codigolayanotacao.mostCurrent,50);
...
try {
		Debug.PushSubsStack("Activity_Resume (codigolayanotacao) ","codigolayanotacao",5,codigolayanotacao.mostCurrent.activityBA,codigolayanotacao.mostCurrent,33);
...
codigolayanotacao.mostCurrent._b4xcombobox1.runClassMethod (b4a.example.b4xcombobox.class, "_setitems" /*RemoteObject*/ ,(Object)(codigolayanotacao.mostCurrent.__c.runMethod(false, "ArrayToList", (Object)(_paginas))));
 BA.debugLineNum = 43;BA.debugLine="If lblAnotacaoRefPag.Text = \"página\" Then";
Debug.ShouldStop(1024);
if (RemoteObject.solveBoolean("=",codigolayanotacao.mostCurrent._lblanotacaorefpag.runMethod(true,"getText"),BA.ObjectToString("página"))) { 
 BA.debugLineNum = 44;BA.debugLine="lblAnotacaoRefPag.Text = \"Anotação referente à p";
...
codigolayanotacao.mostCurrent._lblanotacaorefpag.runMethod(true,"setText",BA.ObjectToCharSequence("Anotação referente à página"));
 ...
 BA.debugLineNum = 46;BA.debugLine="lblAnotacaoRefPag.Text = \"Anotação referente ao";
...
try {
		Debug.PushSubsStack("btCancelar_Click (codigolayanotacao) ","codigolayanotacao",5,codigolayanotacao.mostCurrent.activityBA,codigolayanotacao.mostCurrent,55);
if (RapidSub.canDelegate("btcancelar_click")) { return b4a.example.codigolayanotacao.remoteMe.runUserSub(false, "codigolayanotacao","btcancelar_click");}
 BA.debugLineNum = 55;BA.debugLine="Sub btCancelar_Click";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 56;BA.debugLine="nomeDoLivro = \"\"";
Debug.ShouldStop(8388608);
codigolayanotacao._nomedolivro = BA.ObjectToString("");
 BA.debugLineNum = 57;BA.debugLine="qtPaginas = 0";
...
try {
		Debug.PushSubsStack("btOk_Click (codigolayanotacao) ","codigolayanotacao",5,codigolayanotacao.mostCurrent.activityBA,codigolayanotacao.mostCurrent,61);
...
//C
this.state = 1;
 BA.debugLineNum = 63;BA.debugLine="If edTituloAnotacao.Text.Trim = \"\" Then";
Debug.ShouldStop(1073741824);
if (true) break;
...
{ BA.debugLineNum = 66;BA.debugLine="Else if edAnotacao.Text.Trim = \"\" Then";
Debug.ShouldStop(2);
...
//C
this.state = 20;
 BA.debugLineNum = 64;BA.debugLine="edTituloAnotacao.RequestFocus";
Debug.ShouldStop(-2147483648);
parent.mostCurrent._edtituloanotacao.runVoidMethod ("RequestFocus");
 BA.debugLineNum = 65;BA.debugLine="ToastMessageShow(\"Insira um título para sua anot";
Debug.ShouldStop(1);
...
//C
this.state = 20;
 BA.debugLineNum = 67;BA.debugLine="edAnotacao.RequestFocus";
Debug.ShouldStop(4);
parent.mostCurrent._edanotacao.runVoidMethod ("RequestFocus");
 BA.debugLineNum = 68;BA.debugLine="ToastMessageShow(\"Cadê a anotação?\",True)";
Debug.ShouldStop(8);
...
this.state = 11;
this.catchState = 18;
 BA.debugLineNum = 72;BA.debugLine="Dim cmd As String";
Debug.ShouldStop(128);
_cmd = RemoteObject.createImmutable("");Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 73;BA.debugLine="cmd = \"exec sp_atualiza_anotacao \" & Main.Id_do";
Debug.ShouldStop(256);
_cmd = RemoteObject.concat(RemoteObject.createImmutable("exec sp_atualiza_anotacao "),parent.mostCurrent._main._id_do_usuario /*RemoteObject*/ ,RemoteObject.createImmutable(", "),parent._codigolivro,RemoteObject.createImmutable(", "),parent.mostCurrent._b4xcombobox1.runClassMethod (b4a.example.b4xcombobox.class, "_getselecteditem" /*RemoteObject*/ ),RemoteObject.createImmutable(", '"),parent.mostCurrent._edtituloanotacao.runMethod(true,"getText"),RemoteObject.createImmutable("','"),parent.mostCurrent._edanotacao.runMethod(true,"getText"),RemoteObject.createImmutable("'"));Debug.locals.put("cmd", _cmd);
 BA.debugLineNum = 79;BA.debugLine="Wait For( banco.Insert_Consulta(cmd)) Complete";
Debug.ShouldStop(16384);
...
{ BA.debugLineNum = 88;BA.debugLine="else if Result.GetString(\"RESULTADO\") = 1 Then";
Debug.ShouldStop(8388608);
...
//C
this.state = 16;
 BA.debugLineNum = 84;BA.debugLine="ToastMessageShow(\"Algo deu errado!\",True)";
Debug.ShouldStop(524288);
parent.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("Algo deu errado!")),(Object)(parent.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 85;BA.debugLine="Sleep(400)";
...
//C
this.state = 16;
 BA.debugLineNum = 89;BA.debugLine="ToastMessageShow(\"Tudo certo\",True)";
Debug.ShouldStop(16777216);
...
this.state = 19;
this.catchState = 0;
 BA.debugLineNum = 95;BA.debugLine="ToastMessageShow(\"Algo deu errado!\",True)";
Debug.ShouldStop(1073741824);
parent.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("Algo deu errado!")),(Object)(parent.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 96;BA.debugLine="Sleep(400)";
Debug.ShouldStop(-2147483648);
parent.mostCurrent.__c.runVoidMethod ("Sleep",codigolayanotacao.mostCurrent.activityBA,anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "codigolayanotacao", "btok_click"),BA.numberCast(int.class, 400));
this.state = 24;
return;
...
try {
		Debug.PushSubsStack("edAnotacao_TextChanged (codigolayanotacao) ","codigolayanotacao",5,codigolayanotacao.mostCurrent.activityBA,codigolayanotacao.mostCurrent,119);
...
Debug.locals.put("New", _new);
 BA.debugLineNum = 119;BA.debugLine="Sub edAnotacao_TextChanged (Old As String, New As";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 120;BA.debugLine="If New.IndexOf(\"'\") >= 0 Then";
Debug.ShouldStop(8388608);
if (RemoteObject.solveBoolean("g",_new.runMethod(true,"indexOf",(Object)(RemoteObject.createImmutable("'"))),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 121;BA.debugLine="edAnotacao.Text = edAnotacao.Text.Replace(\"'\",\"\"";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("edTituloAnotacao_TextChanged (codigolayanotacao) ","codigolayanotacao",5,codigolayanotacao.mostCurrent.activityBA,codigolayanotacao.mostCurrent,113);
...
Debug.locals.put("Old", _old);
Debug.locals.put("New", _new);
 BA.debugLineNum = 113;BA.debugLine="Sub edTituloAnotacao_TextChanged (Old As String, N";
Debug.ShouldStop(65536);
 BA.debugLineNum = 114;BA.debugLine="If New.IndexOf(\"'\") >= 0 Then";
Debug.ShouldStop(131072);
if (RemoteObject.solveBoolean("g",_new.runMethod(true,"indexOf",(Object)(RemoteObject.createImmutable("'"))),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 115;BA.debugLine="edTituloAnotacao.Text = edTituloAnotacao.Text.Re";
Debug.ShouldStop(262144);
