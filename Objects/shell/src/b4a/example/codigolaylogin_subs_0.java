...
try {
		Debug.PushSubsStack("Activity_Create (codigolaylogin) ","codigolaylogin",2,codigolaylogin.mostCurrent.activityBA,codigolaylogin.mostCurrent,14);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (codigolaylogin) ","codigolaylogin",2,codigolaylogin.mostCurrent.activityBA,codigolaylogin.mostCurrent,112);
...
try {
		Debug.PushSubsStack("Activity_Pause (codigolaylogin) ","codigolaylogin",2,codigolaylogin.mostCurrent.activityBA,codigolaylogin.mostCurrent,89);
...
try {
		Debug.PushSubsStack("Activity_Resume (codigolaylogin) ","codigolaylogin",2,codigolaylogin.mostCurrent.activityBA,codigolaylogin.mostCurrent,85);
...
try {
		Debug.PushSubsStack("btCadastro_Click (codigolaylogin) ","codigolaylogin",2,codigolaylogin.mostCurrent.activityBA,codigolaylogin.mostCurrent,93);
...
try {
		Debug.PushSubsStack("btConectar_Click (codigolaylogin) ","codigolaylogin",2,codigolaylogin.mostCurrent.activityBA,codigolaylogin.mostCurrent,31);
...
try {
		Debug.PushSubsStack("EdLogin_TextChanged (codigolaylogin) ","codigolaylogin",2,codigolaylogin.mostCurrent.activityBA,codigolaylogin.mostCurrent,105);
...
try {
		Debug.PushSubsStack("EdSenha_TextChanged (codigolaylogin) ","codigolaylogin",2,codigolaylogin.mostCurrent.activityBA,codigolaylogin.mostCurrent,98);
