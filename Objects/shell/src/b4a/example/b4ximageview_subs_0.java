...
try {
		Debug.PushSubsStack("Base_Resize (b4ximageview) ","b4ximageview",15,__ref.getField(false, "ba"),__ref,38);
...
try {
		Debug.PushSubsStack("Clear (b4ximageview) ","b4ximageview",15,__ref.getField(false, "ba"),__ref,107);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4ximageview) ","b4ximageview",15,__ref.getField(false, "ba"),__ref,24);
...
try {
		Debug.PushSubsStack("getBitmap (b4ximageview) ","b4ximageview",15,__ref.getField(false, "ba"),__ref,118);
...
try {
		Debug.PushSubsStack("getResizeMode (b4ximageview) ","b4ximageview",15,__ref.getField(false, "ba"),__ref,55);
...
try {
		Debug.PushSubsStack("getRoundedImage (b4ximageview) ","b4ximageview",15,__ref.getField(false, "ba"),__ref,43);
...
try {
		Debug.PushSubsStack("Initialize (b4ximageview) ","b4ximageview",15,__ref.getField(false, "ba"),__ref,18);
...
try {
		Debug.PushSubsStack("Load (b4ximageview) ","b4ximageview",15,__ref.getField(false, "ba"),__ref,98);
...
try {
		Debug.PushSubsStack("setBitmap (b4ximageview) ","b4ximageview",15,__ref.getField(false, "ba"),__ref,112);
...
try {
		Debug.PushSubsStack("SetCircleClip (b4ximageview) ","b4ximageview",15,__ref.getField(false, "ba"),__ref,122);
...
try {
		Debug.PushSubsStack("setResizeMode (b4ximageview) ","b4ximageview",15,__ref.getField(false, "ba"),__ref,59);
...
try {
		Debug.PushSubsStack("setRoundedImage (b4ximageview) ","b4ximageview",15,__ref.getField(false, "ba"),__ref,47);
...
try {
		Debug.PushSubsStack("Update (b4ximageview) ","b4ximageview",15,__ref.getField(false, "ba"),__ref,65);
...
Debug.JustUpdateDeviceLine();
b4ximageview.__c.runVoidMethod ("LogImpl","910813467",RemoteObject.concat(RemoteObject.createImmutable("Invalid resize mode: "),__ref.getField(true,"_mresizemode" /*RemoteObject*/ )),0);
 break; }
}
;
