...
public static RemoteObject _lblincongruenciatitulo = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblincongruenciaautor = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblincongruenciametapagoucap = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblincongruenciapagoucap = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _rotulo = RemoteObject.declareNull("b4a.example.act_telacadastro._rotulodimencoes");
public static RemoteObject _edit = RemoteObject.declareNull("b4a.example.act_telacadastro._edit");
public static RemoteObject _negritoitalico = RemoteObject.declareNull("anywheresoftware.b4a.keywords.constants.TypefaceWrapper");
...
public static RemoteObject _txt_titulo_invalido = RemoteObject.createImmutable(false);
public static RemoteObject _txt_autor_invalido = RemoteObject.createImmutable(false);
public static RemoteObject _txt_pagoucap_invalido = RemoteObject.createImmutable(false);
public static RemoteObject _txt_metapagoucap_invalido = RemoteObject.createImmutable(false);
...
public static b4a.example.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",act_telacadastro.mostCurrent._activity,"B4XImagem",act_telacadastro.mostCurrent._b4ximagem,"banco",act_telacadastro.mostCurrent._banco,"btAddFoto",act_telacadastro.mostCurrent._btaddfoto,"btCancelar",act_telacadastro.mostCurrent._btcancelar,"btSalvar",act_telacadastro.mostCurrent._btsalvar,"Codigo_LayDetalhesLivro",Debug.moduleToString(b4a.example.codigo_laydetalheslivro.class),"CodigoCadastro",Debug.moduleToString(b4a.example.codigocadastro.class),"CodigoLancamentoLeitura",Debug.moduleToString(b4a.example.codigolancamentoleitura.class),"CodigoLayAnotacao",Debug.moduleToString(b4a.example.codigolayanotacao.class),"CodigoLayLeituras",Debug.moduleToString(b4a.example.codigolayleituras.class),"CodigoLayLogin",Debug.moduleToString(b4a.example.codigolaylogin.class),"dataPrevistaFinal",act_telacadastro.mostCurrent._dataprevistafinal,"DateUtils",act_telacadastro.mostCurrent._dateutils,"edB4XFloatAutorLivro",act_telacadastro.mostCurrent._edb4xfloatautorlivro,"edB4XFloatMetaPagCap",act_telacadastro.mostCurrent._edb4xfloatmetapagcap,"edB4XFloatNomeLivro",act_telacadastro.mostCurrent._edb4xfloatnomelivro,"edB4XFloatPagOuCap",act_telacadastro.mostCurrent._edb4xfloatpagoucap,"edit",act_telacadastro.mostCurrent._edit,"hoje",act_telacadastro.mostCurrent._hoje,"lblDadosLivro",act_telacadastro.mostCurrent._lbldadoslivro,"lblDataPrevisao",act_telacadastro.mostCurrent._lbldataprevisao,"lblIncongruenciaAutor",act_telacadastro.mostCurrent._lblincongruenciaautor,"lblIncongruenciaMetaPagOuCap",act_telacadastro.mostCurrent._lblincongruenciametapagoucap,"lblIncongruenciaPagOuCap",act_telacadastro.mostCurrent._lblincongruenciapagoucap,"lblIncongruenciaTitulo",act_telacadastro.mostCurrent._lblincongruenciatitulo,"lblMaximoDigitosAutor",act_telacadastro.mostCurrent._lblmaximodigitosautor,"lblMaximoDigitosMetaPagOuCap",act_telacadastro.mostCurrent._lblmaximodigitosmetapagoucap,"lblMaximoDigitosPagOuCap",act_telacadastro.mostCurrent._lblmaximodigitospagoucap,"lblMaximoDigitosTitulo",act_telacadastro.mostCurrent._lblmaximodigitostitulo,"lblMeta",act_telacadastro.mostCurrent._lblmeta,"lblPrevisaoTermino",act_telacadastro.mostCurrent._lblprevisaotermino,"lblQuantidadeDias",act_telacadastro.mostCurrent._lblquantidadedias,"lblTipoLeitura",act_telacadastro.mostCurrent._lbltipoleitura,"Main",Debug.moduleToString(b4a.example.main.class),"modulo_funcoes",Debug.moduleToString(b4a.example.modulo_funcoes.class),"negritoItalico",act_telacadastro.mostCurrent._negritoitalico,"painelImagem",act_telacadastro.mostCurrent._painelimagem,"panelCabecalho",act_telacadastro.mostCurrent._panelcabecalho,"panelDataPrevistaFim",act_telacadastro.mostCurrent._paneldataprevistafim,"panelEdAutorLivro",act_telacadastro.mostCurrent._paneledautorlivro,"panelEdits",act_telacadastro.mostCurrent._paneledits,"panelEdPaginasOuCap",act_telacadastro.mostCurrent._paneledpaginasoucap,"panelEdTituloLivro",act_telacadastro.mostCurrent._paneledtitulolivro,"panelMeta",act_telacadastro.mostCurrent._panelmeta,"radCapitulo",act_telacadastro.mostCurrent._radcapitulo,"radPagina",act_telacadastro.mostCurrent._radpagina,"rotulo",act_telacadastro.mostCurrent._rotulo,"scrol",act_telacadastro.mostCurrent._scrol,"Starter",Debug.moduleToString(b4a.example.starter.class),"txt_Autor_invalido",act_telacadastro._txt_autor_invalido,"txt_MetaPagOuCap_invalido",act_telacadastro._txt_metapagoucap_invalido,"txt_PagOuCap_invalido",act_telacadastro._txt_pagoucap_invalido,"txt_titulo_invalido",act_telacadastro._txt_titulo_invalido,"XUIViewsUtils",Debug.moduleToString(b4a.example.xuiviewsutils.class)};
}
}