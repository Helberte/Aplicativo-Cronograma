...
try {
		Debug.PushSubsStack("Activity_Create (codigocadastro) ","codigocadastro",2,codigocadastro.mostCurrent.activityBA,codigocadastro.mostCurrent,24);
...
try {
		Debug.PushSubsStack("Activity_KeyPress (codigocadastro) ","codigocadastro",2,codigocadastro.mostCurrent.activityBA,codigocadastro.mostCurrent,139);
...
try {
		Debug.PushSubsStack("Activity_Pause (codigocadastro) ","codigocadastro",2,codigocadastro.mostCurrent.activityBA,codigocadastro.mostCurrent,38);
...
try {
		Debug.PushSubsStack("Activity_Resume (codigocadastro) ","codigocadastro",2,codigocadastro.mostCurrent.activityBA,codigocadastro.mostCurrent,34);
...
try {
		Debug.PushSubsStack("btSalvar_Click (codigocadastro) ","codigocadastro",2,codigocadastro.mostCurrent.activityBA,codigocadastro.mostCurrent,42);
...
try {
		Debug.PushSubsStack("edRepitaSenha_TextChanged (codigocadastro) ","codigocadastro",2,codigocadastro.mostCurrent.activityBA,codigocadastro.mostCurrent,131);
...
try {
		Debug.PushSubsStack("edSenha_TextChanged (codigocadastro) ","codigocadastro",2,codigocadastro.mostCurrent.activityBA,codigocadastro.mostCurrent,123);
...
try {
		Debug.PushSubsStack("lblMostrarSenha_Click (codigocadastro) ","codigocadastro",2,codigocadastro.mostCurrent.activityBA,codigocadastro.mostCurrent,149);
