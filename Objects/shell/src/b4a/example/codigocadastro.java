...
public static b4a.example.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"act_TelaCadastro",Debug.moduleToString(b4a.example.act_telacadastro.class),"Activity",codigocadastro.mostCurrent._activity,"Codigo_LayDetalhesLivro",Debug.moduleToString(b4a.example.codigo_laydetalheslivro.class),"CodigoLancamentoLeitura",Debug.moduleToString(b4a.example.codigolancamentoleitura.class),"CodigoLayAnotacao",Debug.moduleToString(b4a.example.codigolayanotacao.class),"CodigoLayLeituras",Debug.moduleToString(b4a.example.codigolayleituras.class),"CodigoLayLogin",Debug.moduleToString(b4a.example.codigolaylogin.class),"DateUtils",codigocadastro.mostCurrent._dateutils,"edLogin",codigocadastro.mostCurrent._edlogin,"edNome",codigocadastro.mostCurrent._ednome,"edRepitaSenha",codigocadastro.mostCurrent._edrepitasenha,"edSenha",codigocadastro.mostCurrent._edsenha,"funcoes",codigocadastro.mostCurrent._funcoes,"lblCadSalvo",codigocadastro.mostCurrent._lblcadsalvo,"lblMostrarSenha",codigocadastro.mostCurrent._lblmostrarsenha,"Main",Debug.moduleToString(b4a.example.main.class),"modulo_funcoes",Debug.moduleToString(b4a.example.modulo_funcoes.class),"mostrarSenha",codigocadastro._mostrarsenha,"panelCadSalvo",codigocadastro.mostCurrent._panelcadsalvo,"Starter",Debug.moduleToString(b4a.example.starter.class),"XUIViewsUtils",Debug.moduleToString(b4a.example.xuiviewsutils.class)};
}
}