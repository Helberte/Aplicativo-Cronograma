...
public static b4a.example.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",codigocadastro.mostCurrent._activity,"cadastrouUsuario",codigocadastro._cadastrouusuario,"CodigoCadastroLivro",Debug.moduleToString(b4a.example.codigocadastrolivro.class),"CodigoLayLeituras",Debug.moduleToString(b4a.example.codigolayleituras.class),"CodigoLayLogin",Debug.moduleToString(b4a.example.codigolaylogin.class),"DateUtils",codigocadastro.mostCurrent._dateutils,"edLogin",codigocadastro.mostCurrent._edlogin,"edNome",codigocadastro.mostCurrent._ednome,"edRepitaSenha",codigocadastro.mostCurrent._edrepitasenha,"edSenha",codigocadastro.mostCurrent._edsenha,"funcoes",codigocadastro.mostCurrent._funcoes,"lblCadSalvo",codigocadastro.mostCurrent._lblcadsalvo,"Main",Debug.moduleToString(b4a.example.main.class),"panelCadSalvo",codigocadastro.mostCurrent._panelcadsalvo,"Starter",Debug.moduleToString(b4a.example.starter.class),"XUIViewsUtils",Debug.moduleToString(b4a.example.xuiviewsutils.class)};
}
}