...
try {
		Debug.PushSubsStack("Conecta (classbancodados) ","classbancodados",4,__ref.getField(false, "ba"),__ref,14);
...
try {
		Debug.PushSubsStack("Initialize (classbancodados) ","classbancodados",4,__ref.getField(false, "ba"),__ref,10);
...
try {
		Debug.PushSubsStack("Insert_Consulta (classbancodados) ","classbancodados",4,__ref.getField(false, "ba"),__ref,26);
