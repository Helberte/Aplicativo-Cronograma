...
classbancodados._jdbcurl = BA.ObjectToString("jdbc:jtds:sqlserver://192.168.1.104:1433;databaseName=cronograma;logintimeout=10");__ref.setField("_jdbcurl",classbancodados._jdbcurl);
...
try {
		Debug.PushSubsStack("Conecta (classbancodados) ","classbancodados",3,__ref.getField(false, "ba"),__ref,14);
...
try {
		Debug.PushSubsStack("Initialize (classbancodados) ","classbancodados",3,__ref.getField(false, "ba"),__ref,10);
...
try {
		Debug.PushSubsStack("Insert_Consulta (classbancodados) ","classbancodados",3,__ref.getField(false, "ba"),__ref,26);
