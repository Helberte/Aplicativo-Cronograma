...
classbancodados._jdbcurl = BA.ObjectToString("jdbc:jtds:sqlserver://192.168.2.2:1433;databaseName=cronograma;logintimeout=10");__ref.setField("_jdbcurl",classbancodados._jdbcurl);
