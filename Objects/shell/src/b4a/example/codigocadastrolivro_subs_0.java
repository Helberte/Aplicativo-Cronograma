...
Debug.ShouldStop(2097152);
_tipoleitura = BA.ObjectToString("PAGINA");Debug.locals.put("tipoLeitura", _tipoleitura);
...
//C
this.state = 34;
_tipoleitura = BA.ObjectToString("CAPITULO");Debug.locals.put("tipoLeitura", _tipoleitura);
if (true) break;
