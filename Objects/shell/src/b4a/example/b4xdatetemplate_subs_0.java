...
try {
		Debug.PushSubsStack("btnMonth_Click (b4xdatetemplate) ","b4xdatetemplate",15,__ref.getField(false, "ba"),__ref,147);
...
try {
		Debug.PushSubsStack("btnYear_Click (b4xdatetemplate) ","b4xdatetemplate",15,__ref.getField(false, "ba"),__ref,141);
...
try {
		Debug.PushSubsStack("DaysPaneFg_Touch (b4xdatetemplate) ","b4xdatetemplate",15,__ref.getField(false, "ba"),__ref,154);
...
try {
		Debug.PushSubsStack("DialogClosed (b4xdatetemplate) ","b4xdatetemplate",15,__ref.getField(false, "ba"),__ref,176);
...
try {
		Debug.PushSubsStack("DrawBox (b4xdatetemplate) ","b4xdatetemplate",15,__ref.getField(false, "ba"),__ref,82);
...
try {
		Debug.PushSubsStack("getDate (b4xdatetemplate) ","b4xdatetemplate",15,__ref.getField(false, "ba"),__ref,89);
...
try {
		Debug.PushSubsStack("GetPanel (b4xdatetemplate) ","b4xdatetemplate",15,__ref.getField(false, "ba"),__ref,159);
...
try {
		Debug.PushSubsStack("HandleMouse (b4xdatetemplate) ","b4xdatetemplate",15,__ref.getField(false, "ba"),__ref,114);
...
try {
		Debug.PushSubsStack("Hide (b4xdatetemplate) ","b4xdatetemplate",15,__ref.getField(false, "ba"),__ref,136);
...
try {
		Debug.PushSubsStack("SelectDay (b4xdatetemplate) ","b4xdatetemplate",15,__ref.getField(false, "ba"),__ref,106);
...
try {
		Debug.PushSubsStack("setDate (b4xdatetemplate) ","b4xdatetemplate",15,__ref.getField(false, "ba"),__ref,93);
...
try {
		Debug.PushSubsStack("Show (b4xdatetemplate) ","b4xdatetemplate",15,__ref.getField(false, "ba"),__ref,163);
