...
public static b4a.example.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",codigolayleituras.mostCurrent._activity,"banco",codigolayleituras.mostCurrent._banco,"btAdicionarLeitura",codigolayleituras.mostCurrent._btadicionarleitura,"CodigoCadastro",Debug.moduleToString(b4a.example.codigocadastro.class),"CodigoCadastroLivro",Debug.moduleToString(b4a.example.codigocadastrolivro.class),"CodigoLayAnotacao",Debug.moduleToString(b4a.example.codigolayanotacao.class),"CodigoLayLogin",Debug.moduleToString(b4a.example.codigolaylogin.class),"cores",codigolayleituras._cores,"DateUtils",codigolayleituras.mostCurrent._dateutils,"gradient",codigolayleituras.mostCurrent._gradient,"lbl_Inicial_Leitura",codigolayleituras.mostCurrent._lbl_inicial_leitura,"Main",Debug.moduleToString(b4a.example.main.class),"Panel_lendo",codigolayleituras.mostCurrent._panel_lendo,"panelNenhumaLeitura",codigolayleituras.mostCurrent._panelnenhumaleitura,"scrollView1",codigolayleituras.mostCurrent._scrollview1,"Starter",Debug.moduleToString(b4a.example.starter.class),"TabStrip",codigolayleituras.mostCurrent._tabstrip,"temPanel",codigolayleituras._tempanel,"XUIViewsUtils",Debug.moduleToString(b4a.example.xuiviewsutils.class)};
}
}