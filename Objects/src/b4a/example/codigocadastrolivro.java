...
//C
this.state = 40;
 //BA.debugLineNum = 265;BA.debugLine="ToastMessageShow(Result.GetString(\"MENSAGEM\"";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(_result.GetString("MENSAGEM")),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 266;BA.debugLine="Sleep(100)";
...
this.state = 40;
;
 //BA.debugLineNum = 267;BA.debugLine="StartActivity(CodigoLayLeituras)";
...
//C
this.state = 40;
 //BA.debugLineNum = 272;BA.debugLine="MsgboxAsync(Result.GetString(\"MENSAGEM\"), \"O";
anywheresoftware.b4a.keywords.Common.MsgboxAsync(BA.ObjectToCharSequence(_result.GetString("MENSAGEM")),BA.ObjectToCharSequence("Ops!!"),processBA);
 //BA.debugLineNum = 273;BA.debugLine="Sleep(1000)";
...
this.state = 40;
;
 //BA.debugLineNum = 274;BA.debugLine="StartActivity(CodigoLayLeituras)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(parent.mostCurrent._codigolayleituras.getObject()));
...
this.state = 43;
this.catchState = 0;
 //BA.debugLineNum = 279;BA.debugLine="MsgboxAsync(\"Problemas ao tentar estabelecer";
