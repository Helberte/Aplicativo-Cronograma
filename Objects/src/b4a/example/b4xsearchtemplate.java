...
RDebugUtils.currentLine=19267596;
 //BA.debugLineNum = 19267596;BA.debugLine="IME.ShowKeyboard(SearchField.TextField)";
...
RDebugUtils.currentLine=19595279;
 //BA.debugLineNum = 19595279;BA.debugLine="pnlColor = ItemHightlightColor";
_pnlcolor = __ref._itemhightlightcolor /*int*/ ;
 }else {
RDebugUtils.currentLine=19595281;
 //BA.debugLineNum = 19595281;BA.debugLine="pnlColor = CustomListView1.DefaultTextBackgroun";
_pnlcolor = __ref._customlistview1 /*b4a.example3.customlistview*/ ._defaulttextbackgroundcolor;
 };
RDebugUtils.currentLine=19595284;
 //BA.debugLineNum = 19595284;BA.debugLine="Dim cs As CSBuilder";
_cs = new anywheresoftware.b4a.objects.CSBuilder();
RDebugUtils.currentLine=19595285;
 //BA.debugLineNum = 19595285;BA.debugLine="cs.Initialize.Append(item.SubString2(0, x)).Colo";
...
RDebugUtils.currentLine=19595286;
 //BA.debugLineNum = 19595286;BA.debugLine="cs.Append(item.SubString(x + full.Length))";
_cs.Append(BA.ObjectToCharSequence(_item.substring((int) (_x+_full.length()))));
RDebugUtils.currentLine=19595287;
 //BA.debugLineNum = 19595287;BA.debugLine="If ItemsCache.Size > 0 Then";
if (__ref._itemscache /*anywheresoftware.b4a.objects.collections.List*/ .getSize()>0) { 
RDebugUtils.currentLine=19595288;
 //BA.debugLineNum = 19595288;BA.debugLine="Dim p As B4XView = ItemsCache.Get(ItemsCache.Si";
...
RDebugUtils.currentLine=19595289;
 //BA.debugLineNum = 19595289;BA.debugLine="ItemsCache.RemoveAt(ItemsCache.Size - 1)";
...
RDebugUtils.currentLine=19595291;
 //BA.debugLineNum = 19595291;BA.debugLine="p.GetView(0).Text = cs";
_p.GetView((int) (0)).setText(BA.ObjectToCharSequence(_cs.getObject()));
RDebugUtils.currentLine=19595296;
 //BA.debugLineNum = 19595296;BA.debugLine="p.Color = pnlColor";
_p.setColor(_pnlcolor);
RDebugUtils.currentLine=19595297;
 //BA.debugLineNum = 19595297;BA.debugLine="CustomListView1.Add(p, item)";
__ref._customlistview1 /*b4a.example3.customlistview*/ ._add(_p,(Object)(_item));
 }else {
RDebugUtils.currentLine=19595299;
 //BA.debugLineNum = 19595299;BA.debugLine="CustomListView1.AddTextItem(cs, item)";
...
RDebugUtils.currentLine=19595320;
 //BA.debugLineNum = 19595320;BA.debugLine="For i = 0 To li.Size - 1";
{
final int step28 = 1;
...
RDebugUtils.currentLine=19595321;
 //BA.debugLineNum = 19595321;BA.debugLine="Dim item As String = li.Get(i)";
_item = BA.ObjectToString(_li.Get(_i));
RDebugUtils.currentLine=19595322;
 //BA.debugLineNum = 19595322;BA.debugLine="Dim x As Int = item.ToLowerCase.IndexOf(full)";
_x = _item.toLowerCase().indexOf(_full);
RDebugUtils.currentLine=19595323;
 //BA.debugLineNum = 19595323;BA.debugLine="If x = -1 Then";
if (_x==-1) { 
RDebugUtils.currentLine=19595324;
 //BA.debugLineNum = 19595324;BA.debugLine="Continue";
if (true) continue;
 };
 }
};
RDebugUtils.currentLine=19595327;
 //BA.debugLineNum = 19595327;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=19005457;
 //BA.debugLineNum = 19005457;BA.debugLine="Private IME As IME";
_ime = new anywheresoftware.b4a.objects.IME();
RDebugUtils.currentLine=19005459;
 //BA.debugLineNum = 19005459;BA.debugLine="Public AllowUnlistedText As Boolean";
_allowunlistedtext = false;
RDebugUtils.currentLine=19005460;
 //BA.debugLineNum = 19005460;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=19071000;
 //BA.debugLineNum = 19071000;BA.debugLine="IME.Initialize(\"\")";
__ref._ime /*anywheresoftware.b4a.objects.IME*/ .Initialize("");
RDebugUtils.currentLine=19071001;
 //BA.debugLineNum = 19071001;BA.debugLine="Dim jo As JavaObject = SearchField.TextField";
...
RDebugUtils.currentLine=19071002;
 //BA.debugLineNum = 19071002;BA.debugLine="jo.RunMethod(\"setImeOptions\", Array(Bit.Or(335544";
...
RDebugUtils.currentLine=19136514;
 //BA.debugLineNum = 19136514;BA.debugLine="Dim c As B4XView = CustomListView1.AsView";
_c = new anywheresoftware.b4a.objects.B4XViewWrapper();
_c = __ref._customlistview1 /*b4a.example3.customlistview*/ ._asview();
RDebugUtils.currentLine=19136515;
 //BA.debugLineNum = 19136515;BA.debugLine="c.SetLayoutAnimated(0, 0, c.Top, Width, Height -";
_c.SetLayoutAnimated((int) (0),(int) (0),_c.getTop(),_width,(int) (_height-_c.getTop()));
RDebugUtils.currentLine=19136516;
 //BA.debugLineNum = 19136516;BA.debugLine="CustomListView1.Base_Resize(Width, c.Height)";
...
RDebugUtils.currentLine=19464193;
 //BA.debugLineNum = 19464193;BA.debugLine="If AllowUnlistedText Then";
if (__ref._allowunlistedtext /*boolean*/ ) { 
RDebugUtils.currentLine=19464194;
 //BA.debugLineNum = 19464194;BA.debugLine="SelectedItem = LastTerm";
__ref._selecteditem /*String*/  = __ref._lastterm /*String*/ ;
RDebugUtils.currentLine=19464195;
 //BA.debugLineNum = 19464195;BA.debugLine="xDialog.Close(xui.DialogResponse_Positive)";
__ref._xdialog /*b4a.example.b4xdialog*/ ._close /*boolean*/ (null,__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .DialogResponse_Positive);
 }else 
{RDebugUtils.currentLine=19464196;
 //BA.debugLineNum = 19464196;BA.debugLine="Else If CustomListView1.Size > 0 And LastTerm.Len";
...
RDebugUtils.currentLine=19464197;
 //BA.debugLineNum = 19464197;BA.debugLine="CustomListView1_ItemClick(0, CustomListView1.Get";
...
RDebugUtils.currentLine=19726341;
 //BA.debugLineNum = 19726341;BA.debugLine="Dim AllItems As List = obj(2)";
_allitems = new anywheresoftware.b4a.objects.collections.List();
...
__c.LogImpl("919660833","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
