...
RDebugUtils.currentLine=13893644;
 //BA.debugLineNum = 13893644;BA.debugLine="IME.ShowKeyboard(SearchField.TextField)";
...
RDebugUtils.currentLine=14221327;
 //BA.debugLineNum = 14221327;BA.debugLine="pnlColor = ItemHightlightColor";
_pnlcolor = __ref._itemhightlightcolor /*int*/ ;
 }else {
RDebugUtils.currentLine=14221329;
 //BA.debugLineNum = 14221329;BA.debugLine="pnlColor = CustomListView1.DefaultTextBackgroun";
_pnlcolor = __ref._customlistview1 /*b4a.example3.customlistview*/ ._defaulttextbackgroundcolor;
 };
RDebugUtils.currentLine=14221332;
 //BA.debugLineNum = 14221332;BA.debugLine="Dim cs As CSBuilder";
_cs = new anywheresoftware.b4a.objects.CSBuilder();
RDebugUtils.currentLine=14221333;
 //BA.debugLineNum = 14221333;BA.debugLine="cs.Initialize.Append(item.SubString2(0, x)).Colo";
...
RDebugUtils.currentLine=14221334;
 //BA.debugLineNum = 14221334;BA.debugLine="cs.Append(item.SubString(x + full.Length))";
_cs.Append(BA.ObjectToCharSequence(_item.substring((int) (_x+_full.length()))));
RDebugUtils.currentLine=14221335;
 //BA.debugLineNum = 14221335;BA.debugLine="If ItemsCache.Size > 0 Then";
if (__ref._itemscache /*anywheresoftware.b4a.objects.collections.List*/ .getSize()>0) { 
RDebugUtils.currentLine=14221336;
 //BA.debugLineNum = 14221336;BA.debugLine="Dim p As B4XView = ItemsCache.Get(ItemsCache.Si";
...
RDebugUtils.currentLine=14221337;
 //BA.debugLineNum = 14221337;BA.debugLine="ItemsCache.RemoveAt(ItemsCache.Size - 1)";
...
RDebugUtils.currentLine=14221339;
 //BA.debugLineNum = 14221339;BA.debugLine="p.GetView(0).Text = cs";
_p.GetView((int) (0)).setText(BA.ObjectToCharSequence(_cs.getObject()));
RDebugUtils.currentLine=14221344;
 //BA.debugLineNum = 14221344;BA.debugLine="p.Color = pnlColor";
_p.setColor(_pnlcolor);
RDebugUtils.currentLine=14221345;
 //BA.debugLineNum = 14221345;BA.debugLine="CustomListView1.Add(p, item)";
__ref._customlistview1 /*b4a.example3.customlistview*/ ._add(_p,(Object)(_item));
 }else {
RDebugUtils.currentLine=14221347;
 //BA.debugLineNum = 14221347;BA.debugLine="CustomListView1.AddTextItem(cs, item)";
...
RDebugUtils.currentLine=14221368;
 //BA.debugLineNum = 14221368;BA.debugLine="For i = 0 To li.Size - 1";
{
final int step28 = 1;
...
RDebugUtils.currentLine=14221369;
 //BA.debugLineNum = 14221369;BA.debugLine="Dim item As String = li.Get(i)";
_item = BA.ObjectToString(_li.Get(_i));
RDebugUtils.currentLine=14221370;
 //BA.debugLineNum = 14221370;BA.debugLine="Dim x As Int = item.ToLowerCase.IndexOf(full)";
_x = _item.toLowerCase().indexOf(_full);
RDebugUtils.currentLine=14221371;
 //BA.debugLineNum = 14221371;BA.debugLine="If x = -1 Then";
if (_x==-1) { 
RDebugUtils.currentLine=14221372;
 //BA.debugLineNum = 14221372;BA.debugLine="Continue";
if (true) continue;
 };
 }
};
RDebugUtils.currentLine=14221375;
 //BA.debugLineNum = 14221375;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=13631505;
 //BA.debugLineNum = 13631505;BA.debugLine="Private IME As IME";
_ime = new anywheresoftware.b4a.objects.IME();
RDebugUtils.currentLine=13631507;
 //BA.debugLineNum = 13631507;BA.debugLine="Public AllowUnlistedText As Boolean";
...
RDebugUtils.currentLine=13697048;
 //BA.debugLineNum = 13697048;BA.debugLine="IME.Initialize(\"\")";
__ref._ime /*anywheresoftware.b4a.objects.IME*/ .Initialize("");
RDebugUtils.currentLine=13697049;
 //BA.debugLineNum = 13697049;BA.debugLine="Dim jo As JavaObject = SearchField.TextField";
...
RDebugUtils.currentLine=13697050;
 //BA.debugLineNum = 13697050;BA.debugLine="jo.RunMethod(\"setImeOptions\", Array(Bit.Or(335544";
...
RDebugUtils.currentLine=14090241;
 //BA.debugLineNum = 14090241;BA.debugLine="If AllowUnlistedText Then";
if (__ref._allowunlistedtext /*boolean*/ ) { 
RDebugUtils.currentLine=14090242;
 //BA.debugLineNum = 14090242;BA.debugLine="SelectedItem = LastTerm";
__ref._selecteditem /*String*/  = __ref._lastterm /*String*/ ;
RDebugUtils.currentLine=14090243;
 //BA.debugLineNum = 14090243;BA.debugLine="xDialog.Close(xui.DialogResponse_Positive)";
__ref._xdialog /*b4a.example.b4xdialog*/ ._close /*boolean*/ (null,__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .DialogResponse_Positive);
 }else 
{RDebugUtils.currentLine=14090244;
 //BA.debugLineNum = 14090244;BA.debugLine="Else If CustomListView1.Size > 0 And LastTerm.Len";
...
RDebugUtils.currentLine=14090245;
 //BA.debugLineNum = 14090245;BA.debugLine="CustomListView1_ItemClick(0, CustomListView1.Get";
...
__c.LogImpl("914286881","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
