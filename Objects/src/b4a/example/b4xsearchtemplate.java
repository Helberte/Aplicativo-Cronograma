...
RDebugUtils.currentLine=18481162;
 //BA.debugLineNum = 18481162;BA.debugLine="Dim item As String";
_item = "";
RDebugUtils.currentLine=18481163;
 //BA.debugLineNum = 18481163;BA.debugLine="item = Items.Get(i)";
_item = BA.ObjectToString(_items.Get(_i));
RDebugUtils.currentLine=18481164;
 //BA.debugLineNum = 18481164;BA.debugLine="item = item.ToLowerCase";
_item = _item.toLowerCase();
RDebugUtils.currentLine=18481165;
 //BA.debugLineNum = 18481165;BA.debugLine="noDuplicates.Clear";
_noduplicates.Clear();
RDebugUtils.currentLine=18481166;
 //BA.debugLineNum = 18481166;BA.debugLine="For start = 0 To item.Length";
{
final int step14 = 1;
...
RDebugUtils.currentLine=18481167;
 //BA.debugLineNum = 18481167;BA.debugLine="Dim count As Int = 1";
_count = (int) (1);
RDebugUtils.currentLine=18481168;
 //BA.debugLineNum = 18481168;BA.debugLine="Do While count <= MAX_LIMIT And start + count <";
while (_count<=__ref._max_limit /*int*/  && _start+_count<=_item.length()) {
RDebugUtils.currentLine=18481169;
 //BA.debugLineNum = 18481169;BA.debugLine="Dim str As String";
_str = "";
RDebugUtils.currentLine=18481170;
 //BA.debugLineNum = 18481170;BA.debugLine="str = item.SubString2(start, start + count)";
_str = _item.substring(_start,(int) (_start+_count));
RDebugUtils.currentLine=18481171;
 //BA.debugLineNum = 18481171;BA.debugLine="If noDuplicates.ContainsKey(str) = False Then";
if (_noduplicates.ContainsKey((Object)(_str))==__c.False) { 
RDebugUtils.currentLine=18481172;
 //BA.debugLineNum = 18481172;BA.debugLine="noDuplicates.Put(str, \"\")";
_noduplicates.Put((Object)(_str),(Object)(""));
RDebugUtils.currentLine=18481173;
 //BA.debugLineNum = 18481173;BA.debugLine="If start = 0 Then m = prefixList Else m = sub";
if (_start==0) { 
_m = __ref._prefixlist /*anywheresoftware.b4a.objects.collections.Map*/ ;}
else {
_m = __ref._substringlist /*anywheresoftware.b4a.objects.collections.Map*/ ;};
RDebugUtils.currentLine=18481174;
 //BA.debugLineNum = 18481174;BA.debugLine="li = m.Get(str)";
_li = (anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(_m.Get((Object)(_str))));
RDebugUtils.currentLine=18481175;
 //BA.debugLineNum = 18481175;BA.debugLine="If li.IsInitialized = False Then";
if (_li.IsInitialized()==__c.False) { 
RDebugUtils.currentLine=18481176;
 //BA.debugLineNum = 18481176;BA.debugLine="li.Initialize";
_li.Initialize();
RDebugUtils.currentLine=18481177;
 //BA.debugLineNum = 18481177;BA.debugLine="m.Put(str, li)";
_m.Put((Object)(_str),(Object)(_li.getObject()));
 };
RDebugUtils.currentLine=18481179;
 //BA.debugLineNum = 18481179;BA.debugLine="li.Add(Items.Get(i)) 'Preserve the original c";
_li.Add(_items.Get(_i));
 };
RDebugUtils.currentLine=18481181;
 //BA.debugLineNum = 18481181;BA.debugLine="count = count + 1";
_count = (int) (_count+1);
 }
;
 }
...
RDebugUtils.currentLine=18481185;
 //BA.debugLineNum = 18481185;BA.debugLine="Log(\"Index time: \" & (DateTime.Now - startTime) &";
__c.LogImpl("918481185","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
RDebugUtils.currentLine=18481186;
 //BA.debugLineNum = 18481186;BA.debugLine="AllItems = Items";
__ref._allitems /*anywheresoftware.b4a.objects.collections.List*/  = _items;
RDebugUtils.currentLine=18481187;
 //BA.debugLineNum = 18481187;BA.debugLine="Return Array(prefixList, substringList, AllItems)";
if (true) return (Object)(new Object[]{(Object)(__ref._prefixlist /*anywheresoftware.b4a.objects.collections.Map*/ .getObject()),(Object)(__ref._substringlist /*anywheresoftware.b4a.objects.collections.Map*/ .getObject()),(Object)(__ref._allitems /*anywheresoftware.b4a.objects.collections.List*/ .getObject())});
RDebugUtils.currentLine=18481188;
 //BA.debugLineNum = 18481188;BA.debugLine="End Sub";
return null;
}
