...
views.get("edpaginaatual").vw.setHeight((int)((6d / 100 * height)));
views.get("edpaginaatual").vw.setLeft((int)((22d / 100 * width)));
...
views.get("lblporcentagem").vw.setTop((int)((views.get("panellancamento").vw.getTop())+(views.get("panellancamento").vw.getHeight())+(3d / 100 * height)));
...
//BA.debugLineNum = 62;BA.debugLine="btOk.Left = panelLancamento.Left + panelLancamento.Width - btOk.Width"[Lay_lancamento_leitura/General script]
...
//BA.debugLineNum = 64;BA.debugLine="btCancelar.Width = btOk.Width"[Lay_lancamento_leitura/General script]
views.get("btcancelar").vw.setWidth((int)((views.get("btok").vw.getWidth())));
//BA.debugLineNum = 65;BA.debugLine="btCancelar.Height = btOk.Height"[Lay_lancamento_leitura/General script]
views.get("btcancelar").vw.setHeight((int)((views.get("btok").vw.getHeight())));
//BA.debugLineNum = 66;BA.debugLine="btCancelar.Top = btOk.Top"[Lay_lancamento_leitura/General script]
views.get("btcancelar").vw.setTop((int)((views.get("btok").vw.getTop())));
//BA.debugLineNum = 67;BA.debugLine="btCancelar.Left = btOk.Left - btCancelar.Width - 2%x"[Lay_lancamento_leitura/General script]
