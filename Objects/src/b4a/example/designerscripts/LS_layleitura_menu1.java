...
views.get("panelleituras").vw.setWidth((int)((views.get("panel_lendo").vw.getWidth())-(((views.get("panel_lendo").vw.getWidth())*3d)/100d)));
views.get("panelleituras").vw.setHeight((int)((25d / 100 * height)));
views.get("panelleituras").vw.setLeft((int)(((views.get("panel_lendo").vw.getWidth())-(views.get("panelleituras").vw.getWidth()))/2d));
