...
RDebugUtils.currentLine=4325377;
 //BA.debugLineNum = 4325377;BA.debugLine="For Each v As B4XView In mBase.GetAllViewsRecursi";
...
RDebugUtils.currentLine=4325378;
 //BA.debugLineNum = 4325378;BA.debugLine="v.SetLayoutAnimated(0, 0, 0, Width, Height)";
_v.SetLayoutAnimated((int) (0),(int) (0),(int) (0),(int) (_width),(int) (_height));
 }
};
RDebugUtils.currentLine=4325380;
 //BA.debugLineNum = 4325380;BA.debugLine="bc.Initialize(mBase.Width / xui.Scale, mBase.Heig";
...
RDebugUtils.currentLine=4325381;
 //BA.debugLineNum = 4325381;BA.debugLine="Vertical = mBase.Height > mBase.Width";
__ref._vertical /*boolean*/  = __ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getHeight()>__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getWidth();
RDebugUtils.currentLine=4325382;
 //BA.debugLineNum = 4325382;BA.debugLine="UpdateGraphics";
...
RDebugUtils.currentLine=4390913;
 //BA.debugLineNum = 4390913;BA.debugLine="Dim MyIndex As Int = BusyIndex";
_myindex = __ref._busyindex /*int*/ ;
RDebugUtils.currentLine=4390914;
 //BA.debugLineNum = 4390914;BA.debugLine="Dim r As B4XRect";
_r = new anywheresoftware.b4a.objects.B4XCanvas.B4XRect();
RDebugUtils.currentLine=4390915;
 //BA.debugLineNum = 4390915;BA.debugLine="r.Initialize(0, 0, bc.mWidth, bc.mHeight)";
...
RDebugUtils.currentLine=4390916;
 //BA.debugLineNum = 4390916;BA.debugLine="Dim LastTime As Long = DateTime.Now";
_lasttime = parent.__c.DateTime.getNow();
RDebugUtils.currentLine=4390917;
 //BA.debugLineNum = 4390917;BA.debugLine="Do While MyIndex = BusyIndex";
if (true) break;
...
RDebugUtils.currentLine=4390918;
 //BA.debugLineNum = 4390918;BA.debugLine="If Vertical Then";
if (true) break;
...
RDebugUtils.currentLine=4390919;
 //BA.debugLineNum = 4390919;BA.debugLine="BusyBrush.SrcOffsetY = BusyBrush.SrcOffsetY + B";
...
RDebugUtils.currentLine=4390921;
 //BA.debugLineNum = 4390921;BA.debugLine="BusyBrush.SrcOffsetX = BusyBrush.SrcOffsetX + B";
...
RDebugUtils.currentLine=4390923;
 //BA.debugLineNum = 4390923;BA.debugLine="Dim tasks As List";
_tasks = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=4390924;
 //BA.debugLineNum = 4390924;BA.debugLine="tasks.Initialize";
_tasks.Initialize();
RDebugUtils.currentLine=4390925;
 //BA.debugLineNum = 4390925;BA.debugLine="tasks.Add(bc.AsyncDrawRect(bc.TargetRect, Transp";
...
RDebugUtils.currentLine=4390926;
 //BA.debugLineNum = 4390926;BA.debugLine="Dim delta As Float = mValue - CurrentValue";
_delta = (float) (__ref._mvalue /*int*/ -__ref._currentvalue /*float*/ );
RDebugUtils.currentLine=4390927;
 //BA.debugLineNum = 4390927;BA.debugLine="If Abs(delta) <= 1 Then";
if (true) break;
...
RDebugUtils.currentLine=4390928;
 //BA.debugLineNum = 4390928;BA.debugLine="CurrentValue = mValue";
...
RDebugUtils.currentLine=4390930;
 //BA.debugLineNum = 4390930;BA.debugLine="Dim change As Float = (DateTime.Now - LastTime)";
...
RDebugUtils.currentLine=4390931;
 //BA.debugLineNum = 4390931;BA.debugLine="If delta > 0 Then";
if (true) break;
...
RDebugUtils.currentLine=4390932;
 //BA.debugLineNum = 4390932;BA.debugLine="CurrentValue = CurrentValue + Min(change, mVal";
...
RDebugUtils.currentLine=4390934;
 //BA.debugLineNum = 4390934;BA.debugLine="CurrentValue = CurrentValue - Min(change, Curr";
...
RDebugUtils.currentLine=4390937;
 //BA.debugLineNum = 4390937;BA.debugLine="LastTime = DateTime.Now";
_lasttime = parent.__c.DateTime.getNow();
RDebugUtils.currentLine=4390938;
 //BA.debugLineNum = 4390938;BA.debugLine="If CurrentValue < 100 Then";
if (true) break;
...
RDebugUtils.currentLine=4390939;
 //BA.debugLineNum = 4390939;BA.debugLine="tasks.Add(bc.AsyncDrawRectRounded(bc.TargetRect";
...
RDebugUtils.currentLine=4390941;
 //BA.debugLineNum = 4390941;BA.debugLine="If Vertical Then";
...
RDebugUtils.currentLine=4390942;
 //BA.debugLineNum = 4390942;BA.debugLine="r.Bottom = Round(CurrentValue / 100 * bc.mHeigh";
...
RDebugUtils.currentLine=4390944;
 //BA.debugLineNum = 4390944;BA.debugLine="r.Right = Round(CurrentValue / 100 * bc.mWidth)";
...
RDebugUtils.currentLine=4390947;
 //BA.debugLineNum = 4390947;BA.debugLine="tasks.Add(bc.AsyncDrawRectRounded(r, BusyBrush,";
...
RDebugUtils.currentLine=4390948;
 //BA.debugLineNum = 4390948;BA.debugLine="bc.DrawBitmapCreatorsAsync(Me, \"BC\", tasks)";
__ref._bc /*b4a.example.bitmapcreator*/ ._drawbitmapcreatorsasync(parent,"BC",_tasks);
RDebugUtils.currentLine=4390949;
 //BA.debugLineNum = 4390949;BA.debugLine="Wait For BC_BitmapReady (bmp As B4XBitmap)";
...
RDebugUtils.currentLine=4390950;
 //BA.debugLineNum = 4390950;BA.debugLine="If xui.IsB4J Then bmp = bc.Bitmap";
if (true) break;
...
RDebugUtils.currentLine=4390951;
 //BA.debugLineNum = 4390951;BA.debugLine="bc.SetBitmapToImageView(bmp, mIV)";
...
RDebugUtils.currentLine=4390952;
 //BA.debugLineNum = 4390952;BA.debugLine="Sleep(30)";
...
RDebugUtils.currentLine=4390954;
 //BA.debugLineNum = 4390954;BA.debugLine="End Sub";
if (true) break;
...
RDebugUtils.currentLine=4128773;
 //BA.debugLineNum = 4128773;BA.debugLine="Private BusyBrush As BCBrush";
_busybrush = new b4a.example.bcpath._bcbrush();
RDebugUtils.currentLine=4128774;
 //BA.debugLineNum = 4128774;BA.debugLine="Private BackgroundColor As Int";
_backgroundcolor = 0;
RDebugUtils.currentLine=4128775;
 //BA.debugLineNum = 4128775;BA.debugLine="Private BusyIndex As Int";
_busyindex = 0;
RDebugUtils.currentLine=4128776;
 //BA.debugLineNum = 4128776;BA.debugLine="Private bc As BitmapCreator";
_bc = new b4a.example.bitmapcreator();
RDebugUtils.currentLine=4128777;
 //BA.debugLineNum = 4128777;BA.debugLine="Private mIV As B4XView";
_miv = new anywheresoftware.b4a.objects.B4XViewWrapper();
RDebugUtils.currentLine=4128778;
 //BA.debugLineNum = 4128778;BA.debugLine="Private TransparentBrush As BCBrush";
_transparentbrush = new b4a.example.bcpath._bcbrush();
RDebugUtils.currentLine=4128779;
 //BA.debugLineNum = 4128779;BA.debugLine="Private Vertical As Boolean";
_vertical = false;
RDebugUtils.currentLine=4128780;
 //BA.debugLineNum = 4128780;BA.debugLine="Private CurrentValue As Float";
_currentvalue = 0f;
RDebugUtils.currentLine=4128781;
 //BA.debugLineNum = 4128781;BA.debugLine="Public EmptyColor As Int = xui.Color_White";
_emptycolor = __ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .Color_White;
RDebugUtils.currentLine=4128782;
 //BA.debugLineNum = 4128782;BA.debugLine="Private EmptyBrush As BCBrush";
_emptybrush = new b4a.example.bcpath._bcbrush();
RDebugUtils.currentLine=4128783;
 //BA.debugLineNum = 4128783;BA.debugLine="Private mValue As Int";
_mvalue = 0;
RDebugUtils.currentLine=4128784;
 //BA.debugLineNum = 4128784;BA.debugLine="Public Tag As Object";
_tag = new Object();
RDebugUtils.currentLine=4128785;
 //BA.debugLineNum = 4128785;BA.debugLine="Public ValueChangePerSecond As Float = 60";
_valuechangepersecond = (float) (60);
RDebugUtils.currentLine=4128786;
 //BA.debugLineNum = 4128786;BA.debugLine="Public CornerRadius As Int";
_cornerradius = 0;
RDebugUtils.currentLine=4128787;
 //BA.debugLineNum = 4128787;BA.debugLine="Public BrushOffsetDelta As Int = 3";
...
RDebugUtils.currentLine=4259842;
 //BA.debugLineNum = 4259842;BA.debugLine="Tag = mBase.Tag : mBase.Tag = Me";
__ref._tag /*Object*/  = __ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getTag();
RDebugUtils.currentLine=4259842;
 //BA.debugLineNum = 4259842;BA.debugLine="Tag = mBase.Tag : mBase.Tag = Me";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setTag(this);
RDebugUtils.currentLine=4259843;
 //BA.debugLineNum = 4259843;BA.debugLine="Dim iv As ImageView";
_iv = new anywheresoftware.b4a.objects.ImageViewWrapper();
RDebugUtils.currentLine=4259844;
 //BA.debugLineNum = 4259844;BA.debugLine="iv.Initialize(\"\")";
_iv.Initialize(ba,"");
RDebugUtils.currentLine=4259845;
 //BA.debugLineNum = 4259845;BA.debugLine="mIV = iv";
...
RDebugUtils.currentLine=4259846;
 //BA.debugLineNum = 4259846;BA.debugLine="mIV.Color = xui.Color_Transparent";
...
RDebugUtils.currentLine=4259847;
 //BA.debugLineNum = 4259847;BA.debugLine="setValue(Props.GetDefault(\"Value\", 100))";
__ref._setvalue /*String*/ (null,(int)(BA.ObjectToNumber(_props.GetDefault((Object)("Value"),(Object)(100)))));
RDebugUtils.currentLine=4259848;
 //BA.debugLineNum = 4259848;BA.debugLine="CurrentValue = mValue";
__ref._currentvalue /*float*/  = (float) (__ref._mvalue /*int*/ );
RDebugUtils.currentLine=4259849;
 //BA.debugLineNum = 4259849;BA.debugLine="mBase.AddView(mIV, 0, 0, 0, 0)";
...
RDebugUtils.currentLine=4259850;
 //BA.debugLineNum = 4259850;BA.debugLine="mBase.AddView(lbl, 0, 0, mBase.Width, mBase.Heigh";
...
RDebugUtils.currentLine=4259851;
 //BA.debugLineNum = 4259851;BA.debugLine="mBase.SetColorAndBorder(xui.Color_Transparent, 0,";
__ref._mbase /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .SetColorAndBorder(__ref._xui /*anywheresoftware.b4a.objects.B4XViewWrapper.XUI*/ .Color_Transparent,(int) (0),(int) (0),(int) (0));
RDebugUtils.currentLine=4259852;
 //BA.debugLineNum = 4259852;BA.debugLine="BackgroundColor = xui.PaintOrColorToColor(Props.G";
...
RDebugUtils.currentLine=4259853;
 //BA.debugLineNum = 4259853;BA.debugLine="CornerRadius = Props.GetDefault(\"CornerRadius\", 1";
...
RDebugUtils.currentLine=4259854;
 //BA.debugLineNum = 4259854;BA.debugLine="Base_Resize(mBase.Width, mBase.Height)";
